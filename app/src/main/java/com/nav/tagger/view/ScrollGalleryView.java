...
public class ScrollGalleryView extends LinearLayout {
    ...
    private com.veinhorn.scrollgalleryview.ScrollGalleryView.OnImageClickListener onImageClickListener;

    private com.veinhorn.scrollgalleryview.ScrollGalleryView.OnImageClickListener innerOnImageClickListener = new com.veinhorn.scrollgalleryview.ScrollGalleryView.OnImageClickListener() {
        @Override
        public void onClick() {
    ...
    public ScrollGalleryView(Context context, AttributeSet attrs) {
        ...
        inflater.inflate(com.veinhorn.scrollgalleryview.R.layout.scroll_gallery_view, this, true);

        horizontalScrollView = (HorizontalScrollView) findViewById(com.veinhorn.scrollgalleryview.R.id.thumbnails_scroll_view);

        thumbnailsContainer = (LinearLayout) findViewById(com.veinhorn.scrollgalleryview.R.id.thumbnails_container);
     ...
     */
    public ScrollGalleryView addOnImageClickListener(com.veinhorn.scrollgalleryview.ScrollGalleryView.OnImageClickListener onImageClickListener) {
    ...
    public void showThumbnails() {
        ...
        ImageViewSliderActivity.toolbar.setVisibility(View.VISIBLE);
    ...
    public void hideThumbnails() {
        ...
        ImageViewSliderActivity.toolbar.setVisibility(View.GONE);
    }
    ...
    private Bitmap getDefaultThumbnail() {
        return ((BitmapDrawable) getContext().getResources().getDrawable(com.veinhorn.scrollgalleryview.R.drawable.placeholder_image)).getBitmap();
    }
    ...
    private void initializeViewPager() {
        viewPager = (HackyViewPager) findViewById(com.veinhorn.scrollgalleryview.R.id.viewPager);
        pagerAdapter = new ScreenSlidePagerAdapter(fragmentManager, mListOfMedia, zoomEnabled, innerOnImageClickListener);
        viewPager.setAdapter(pagerAdapter);
